...
function Top10Card({ item, rank, title, genres, accentColor, index, onOpen }: {
  ...
  // Largeur du chiffre pour décaler la carte
  const numWidth = rank < 10 ? 70 : 90 // px
  const cardWidth = 260
  ...
  return (
    <motion.div
      ...
      style={{ width: numWidth + cardWidth - 20 }} // overlap de 20px : chiffre dépasse sur la carte
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
      onClick={onOpen}
    >
      {/* Chiffre à gauche, centré verticalement, dépasse légèrement sur la carte */}
      <div
      ...
      {/* Carte image, décalée à droite du chiffre avec léger overlap */}
      <div
      ...
      {/* Spacer pour maintenir la hauteur (aspect ratio 16/9 de cardWidth) */}
