  ...
  <path d="M18 9h.01" stroke="white" strokeWidth="2" strokeLinecap="round" />
              ...
              <AnimatePresence>
                {isSearchOpen && searchResults.length > 0 && (
                  <motion.div
                    ...
                    style={{ background: 'rgba(16,16,18,0.96)', backdropFilter: 'blur(24px)', border: '1px solid rgba(255,255,255,0.12)' }}
                  >
        ...
        {!user && (
          <div className="pointer-events-auto hidden md:flex" style={{ marginRight: '1rem' }}>
            <Link href="/login">
              <div
                className="flex items-center gap-2 pl-5 pr-4 py-2.5 rounded-full bg-white text-black text-[13px] font-bold tracking-wide transition-all duration-200 active:scale-95 hover:bg-white/90"
                style={{
